# Written by Vishal Zambre
# Last Modified by 24th March 2014
require 'spec_helper'

describe Spree::PaymentMethod::CashOnDelivery do
  before(:each) do
    @order = Spree::Order.new
    @payment_method = Spree::PaymentMethod::CashOnDelivery.create! :name => "Cash On Delivery", :environment => Rails.env, :active => true
